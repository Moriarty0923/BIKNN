...
class VanillaKNNMTDecoder(TransformerDecoder):
    ...
    def get_normalized_probs(
        ...
        if self.args.knn_mode == "inference":
            ...
            combined_prob, _ = self.combiner.get_combined_prob(knn_prob=knn_prob, neural_model_logit=net_output[0], log_probs=log_probs)
...
@register_model_architecture("vanilla_knn_mt", "vanilla_knn_mt@transformer_big")
...
@register_model_architecture("vanilla_knn_mt", "vanilla_knn_mt@transformer_8192")
def transformer_8192(args):
    archs.transformer_wmt19_de_en(args)

@register_model_architecture("vanilla_knn_mt", "vanilla_knn_mt@transformer_8192_trained")
def transformer_8192_trained(args):
    archs.transformer_wmt19_de_en(args)
