...
from fairseq.data import (
    data_utils, DiscoDictionary, LanguagePairDataset, ConcatDataset,data_utils,
...
@register_task('translation_disco')
class TranslationSelfTask(FairseqTask):
    ...
    def setup_task(cls, args, **kwargs):
        ...
        # load dictionaries
        src_dict = DiscoDictionary.load(os.path.join(args.data[0], 'dict.{}.txt'.format(args.source_lang)))
        tgt_dict = DiscoDictionary.load(os.path.join(args.data[0], 'dict.{}.txt'.format(args.target_lang)))
    ...
    def load_dataset(self, split, combine=False, epoch=0, **kwargs):
        ...
        for dk, data_path in enumerate(data_paths):
            for k in itertools.count():
                ...
                ##############################
                src_datasets.append(data_utils.load_indexed_dataset(
                    prefix + src, self.src_dict
                ))
                tgt_datasets.append(data_utils.load_indexed_dataset(
